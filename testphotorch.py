...
fitresult = fvcb.fit(fvcbm, learn_rate= 0.06, device='cpu', maxiteration = 20000, minloss= 1, fitcorr=False) # If temp type is 0, do not set fitcorr to True
...
# plt.legend(['Fitted gsw', 'Measured gsw'])
# plt.show()
